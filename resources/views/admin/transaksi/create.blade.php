            ...
            <div class="card-body">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-8">
                        <form method="GET">
                            <div class="d-flex">
                                <select name="produk-id" class="form-control" id="">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-8">
                        <input type="text" value="{{ isset($p_detail) ? $p_detail->name : '' }}" class="form-control" name="nama_produk">
                    </div>
                </div>
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-8">
                        <input type="text" value="{{ isset($p_detail) ? $p_detail->harga : '' }}" class="form-control" name="harga_satuan">
                    </div>
                </div>
